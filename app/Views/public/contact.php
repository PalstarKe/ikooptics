                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-4 p-4 rounded-xl bg-gray-50 dark:bg-navy-800">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">+254 700 000 000</p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4 p-4 rounded-xl bg-gray-50 dark:bg-navy-800">
                            <div class="w-10 h-10 rounded-lg gradient-primary flex items-center justify-center flex-shrink-0">
                        ...
                        <a href="https://wa.me/254700000000" class="flex items-center space-x-4 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
